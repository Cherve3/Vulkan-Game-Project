...
void gf3d_pipeline_create_basic_sprite_descriptor_pool(Pipeline *pipe);
void gf3d_pipeline_create_basic_sprite_descriptor_set_layout(Pipeline *pipe);
...
void gf3d_pipeline_render_pass_model_setup(Pipeline *pipe)
{
...
//    rasterizer.frontFace = VK_FRONT_FACE_CLOCKWISE;
    ...
    gf3d_pipeline_render_pass_model_setup(pipe);
...
void gf3d_pipeline_render_pass_sprite_setup(Pipeline *pipe)
{
	VkAttachmentDescription colorAttachment = { 0 };
	VkAttachmentReference colorAttachmentRef = { 0 };
	VkSubpassDescription subpass = { 0 };
...
Pipeline *gf3d_pipeline_basic_sprite_create(VkDevice device, char *vertFile, char *fragFile, VkExtent2D extent, Uint32 descriptorCount)
{
	...
	gf3d_pipeline_render_pass_sprite_setup(pipe);
...
void gf3d_pipeline_create_descriptor_sets(Pipeline *pipe)
{
	...
	pipe->descriptorSetCount = 100;// gf3d_pipeline.chainLength;
}
